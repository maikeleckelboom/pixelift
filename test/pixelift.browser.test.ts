...
describe('Browser Environment', () => {
  ...
  it('decodes PNG correctly', async () => {
    // const externalUrl = 'https://upload.wikimedia.org/wikipedia/commons/4/47/PNG_transparency_demonstration_1.png'
  ...
  it('handles 3-channel JPG', async () => {
    // const externalUrl = 'https://upload.wikimedia.org/wikipedia/commons/d/df/Close_wing_Basking_of_Athyma_perius_%28Linnaeus%2C_1758%29_-_Common_Sergeant_%284%29_WLB.jpg'
  ...
  it('decodes GIF correctly', async () => {
    // const externalUrl = 'https://upload.wikimedia.org/wikipedia/commons/2/2c/Rotating_earth_%28large%29.gif'
  ...
  it('decodes WebP correctly', async () => {
    // const externalUrl = 'https://upload.wikimedia.org/wikipedia/commons/b/bc/Free-Instagram.webp'
