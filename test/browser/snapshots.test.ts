...
import { pixelift } from '../../src/browser/index';
...
// const imageModules = import.meta.glob('../__fixtures__/pixelift.*', {
//   query: 'url',
//   eager: true
// });
//
// const textModules = import.meta.glob('../__fixtures__/__snapshots__/pixelift.*', {
//   query: 'url',
//   eager: true
// });
...
`(
  'decodes $format image and matches snapshot',
